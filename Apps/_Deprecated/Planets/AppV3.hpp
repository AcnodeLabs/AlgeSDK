...
public:
    ...
    GameObject planets[10];
    
    void Init(char* path) {
        AlInit(STANDARD);
     //   alAlphaTest(1);
        
        AddResource(&planets[0], "mecrury");
          /*  AddResource(&planets[1], "venus");
        AddResource(&planets[2], "earth");
        AddResource(&planets[3], "moon");
        AddResource(&planets[4], "mars");
        AddResource(&planets[5], "jupiter");
        AddResource(&planets[6], "saturn");
        AddResource(&planets[7], "uranus");
        AddResource(&planets[8], "neptune");
        AddResource(&planets[9], "pluto");
