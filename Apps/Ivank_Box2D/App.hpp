...
//    }
	...
	virtual void Init(char* path) {
        ...
        AddResourceEx(&boxes, "box", 90, false, oSize, density, restitution);//false::Polygon/Box
        AddResourceEx(&balls, "bigball",90, true, oSize, density, restitution* 2.0);//true:Circle
	}
};
