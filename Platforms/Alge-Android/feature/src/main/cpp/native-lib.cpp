...
//////////////////INCLUDE R1 CODE
#include "app-android.c"
/////////////////


extern "C" JNIEXPORT jstring
JNICALL
Java_com_acnodelabs_apps_untitled_feature_MainActivity_stringFromJNI( JNIEnv *env, jobject thiz) {
    std::string hello = "3:15 ";

    Java_com_acnodelabs_alge_DemoRenderer_nativeInit(env,thiz,env->NewStringUTF(hello.c_str()));
